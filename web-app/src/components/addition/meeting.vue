    ...
    <div class="mx-auto pt-4" style="width:800px">
      <form class="m-75 mx-auto">
        <div class="pt-sm-3" v-for="(value,key,index) in meeting" :key="index">
          <div class="form-group row" v-if="key!='type' && key !='payType'">
            <label
          ...
          <div class="form-group row" v-else-if="key=='type'">
            ...
            <div class="col-sm-6">
              <!--<textarea
                ...
                v-model="meeting[key]"
              ></textarea>-->
              <!--<select-code v-model="meeting.type" type="income"></select-code>-->
          ...
          <div class="form-group row" v-else-if="key=='payType'">
            ...
            >{{inputGroup[index].title}}</label>
            <div class="col-sm-6">
              <!--<select-code v-model="meeting.payType" type="payType"></select-code>-->
...
export default {
  ...
  methods: {
    putIn() {
      if (this.isRight) {
        req.POST(url.meeting.insert, this.meeting).then(data => {
            this.$router.push({
