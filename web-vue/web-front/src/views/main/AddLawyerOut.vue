<template>
  <div class="w-100">
    <tableNav localName="添加律所支出" showFirstBtn="true" firstBtnName="返回" :firstCallBack="putOff"></tableNav>
        ...
        methods: {
            putIn() {
                ...
                this.$refs['payForm'].validate(valid => {
                    req.POST('pay/detail/insertLawyerOut', this.pay, function (response) {
                        scope.$router.push({
                            name: 'Success',
                            query: {
                                message: "增加律所支出成功",
